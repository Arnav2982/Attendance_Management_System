...
int admin_view(){
    ...
    while(1){
        ...
        cout<<"\n 6 Get list of student wwith their attendance count" ; 
        cout<<"\n 0 Go back <-\n" ; 
        int choice;
        cout<<"\n Enter your choice: ";
        cin>>choice;
...
int get_all_students_by_rollno(){
    cout<<"\n List off all students by their roll no\n";
    cout<<"\n Please press nay key to continue...";
    getchar();
    getchar();
    return 0;
...
int delete_student_by_rollno(){
    cout<<"\n Delete any students by their roll no\n";
    cout<<"\n Please press nay key to continue...";
    getchar();
    getchar();
    return 0;
...
int check_presence_count_by_rollno(){
    cout<<"\n Check presence count of any students by their roll no\n";
    cout<<"\n Please press nay key to continue...";
    getchar();
    getchar();
    return 0;
...
int check_all_presence_count_by_rollno(){
    cout<<"\n Check presence count of all students by their roll no\n";
    cout<<"\n Please press nay key to continue...";
    getchar();
    getchar();
    return 0;
...
int get_list_of_students_with_their_presence_count(){
    cout<<"\n Check list o students registered by username";
    ifstream read;
    read.open("db.dat");
